...
router.post('/add', async (req, res) => {
    const {name,place,proposalType,eventType,budget,startDate,endDate,description,images,food,events,contacts,vendorId} = req.body
    try {
        const upload = new Proposal({
            name,place,proposalType,eventType,budget,startDate,endDate,description,images,food,events,contacts,vendorId
        })
